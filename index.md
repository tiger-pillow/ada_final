...
### Different historical events have affected the sequential movie industry. Using regression analysis, it was discovered that two events had significance in all three regression coefficients: Apollo 13 and Pearl Harbor. While the attack of Pearl Harbor led to an increase in similar movies, the Apollo 13 mission, as well as Apollo 11, decreased the popularity of space-like movies. Furthermore, war movies show a slight decrease in popularity, followed by an increase over time after wars like the Vietnam War, the Cold war, and the Falkland Islands War. Movies similar to the Construction of the Berlin wall follow a similar trend of a slight decrease followed by a prolonged increase. On the contrary, the falling of the Berlin Wall resulted in only a momentary rise in popularity. Lastly, assassination events, like the ones with President Kennedy and Regan, led to a noticeable increase in movies with similar plots after those events. The increase is likely due to the momentary intensity of the events.

### We found 18 out of 23 events to have a defined popularity latency where the average is 9,5 years, the median is 9, and we have two extremes for the events of The Civil Rights Act and The Cold War with 43 and 60 years of popularity latency, respectively.
